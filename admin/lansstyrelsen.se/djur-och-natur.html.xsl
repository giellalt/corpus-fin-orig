...
<xsl:variable name="para_eng" select="'djur-och-natur.html'"/>
...
<xsl:variable name="para_sma" select="'djur-och-natur.html'"/>
<xsl:variable name="para_sme" select="'djur-och-natur.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'djur-och-natur.html'"/>
