...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.lansstyrelsen.se/stockholm/SiteCollectionDocuments/Sv/manniska-och-samhalle/nationella-minoriteter/Folder_grundskyddet_finska.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="folder_grundskyddet_engelska.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="folder_grundskyddet_sydsamiska.pdf"/>
        <parallel_text xml:lang="sme" location="folder_grundskyddet_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location="folder_grundskyddet-lulesamiska.pdf"/>
...
<parallel_text location="folder_grundskyddet_romaniarli.pdf" xml:lang="rmn"/>
</xsl:variable>
