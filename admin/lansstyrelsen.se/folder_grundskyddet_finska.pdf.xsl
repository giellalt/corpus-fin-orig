...
<xsl:variable name="para_eng" select="'folder_grundskyddet_engelska.pdf'"/>
...
<xsl:variable name="para_sma" select="'folder_grundskyddet_sydsamiska.pdf'"/>
<xsl:variable name="para_sme" select="'folder_grundskyddet_nordsamiska.pdf'"/>
<xsl:variable name="para_smj" select="'folder_grundskyddet - lulesamiska.pdf'"/>
<xsl:variable name="para_swe" select="'folder_med_loggor_ny_strecket_cf.pdf'"/>
