...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/skane/Fi/naringsliv-och-foreningar/Pages/default.aspx'"/>
...
<xsl:variable name="para_eng" select="'naringsliv-och-foreningar.html'"/>
...
<xsl:variable name="para_sma" select="'naringsliv-och-foreningar.html'"/>
<xsl:variable name="para_sme" select="'naringsliv-och-foreningar.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'naringsliv-och-foreningar.html'"/>
