...
<xsl:variable name="para_eng" select="'miljo-och-klimat.html'"/>
...
<xsl:variable name="para_sma" select="'miljo-och-klimat.html'"/>
<xsl:variable name="para_sme" select="'miljo-och-klimat.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'miljo-och-klimat.html'"/>
