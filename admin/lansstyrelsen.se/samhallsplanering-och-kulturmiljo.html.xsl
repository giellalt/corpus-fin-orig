...
<xsl:variable name="para_eng" select="'samhallsplanering-och-kulturmiljo.html'"/>
...
<xsl:variable name="para_sma" select="'samhallsplanering-och-kulturmiljo.html'"/>
<xsl:variable name="para_sme" select="'samhallsplanering-och-kulturmiljo.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'samhallsplanering-och-kulturmiljo.html'"/>
