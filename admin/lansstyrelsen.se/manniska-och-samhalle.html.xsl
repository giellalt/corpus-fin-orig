...
<xsl:variable name="para_eng" select="'manniska-och-samhalle.html'"/>
...
<xsl:variable name="para_sma" select="'manniska-och-samhalle.html'"/>
<xsl:variable name="para_sme" select="'manniska-och-samhalle.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'manniska-och-samhalle.html'"/>
