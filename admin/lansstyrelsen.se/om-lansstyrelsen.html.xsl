...
<xsl:variable name="para_eng" select="'om-lansstyrelsen.html'"/>
...
<xsl:variable name="para_sma" select="'om-lansstyrelsen.html'"/>
<xsl:variable name="para_sme" select="'om-lansstyrelsen.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'om-lansstyrelsen.html'"/>
