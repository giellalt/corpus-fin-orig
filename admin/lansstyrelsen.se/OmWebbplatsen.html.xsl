...
<xsl:variable name="para_eng" select="'OmWebbplatsen.html'"/>
...
<xsl:variable name="para_sma" select="'OmWebbplatsen.html'"/>
<xsl:variable name="para_sme" select="'OmWebbplatsen.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'OmWebbplatsen.html'"/>
