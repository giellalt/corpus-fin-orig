...
<xsl:variable name="para_eng" select="'startsida.html'"/>
...
<xsl:variable name="para_sma" select="'startsida.html'"/>
<xsl:variable name="para_sme" select="'startsida.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'startsida.html'"/>
