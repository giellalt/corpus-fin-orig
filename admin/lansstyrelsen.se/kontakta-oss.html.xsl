...
<xsl:variable name="filename" select="'http://www.lansstyrelsen.se/vasterbotten/Fi/kontakta-oss/Pages/default.aspx'"/>
...
<xsl:variable name="parallels">
  ...
  <!-- <parallel_text xml:lang="swe" location=""/> -->
	<parallel_text xml:lang="fit" location="kontakta-oss.html"/>
	<parallel_text xml:lang="sma" location="kontakta-oss.html"/>
	<parallel_text xml:lang="sme" location="kontakta-oss.html"/>
	<parallel_text xml:lang="rmu" location="kontakta-oss.html"/>
	<parallel_text xml:lang="rmf" location="kontakta-oss.html"/>
	<parallel_text xml:lang="eng" location="kontakta-oss.html"/>
	<parallel_text xml:lang="rmy-rlo" location="kontakta-oss.html"/>
	<parallel_text xml:lang="swe" location="kontakta-oss.html"/>
	<parallel_text xml:lang="yid" location="kontakta-oss.html"/>
</xsl:variable>
