...
<xsl:variable name="para_eng" select="'lantbruk-och-landsbygd.html'"/>
...
<xsl:variable name="para_sma" select="'lantbruk-och-landsbygd.html'"/>
<xsl:variable name="para_sme" select="'lantbruk-och-landsbygd.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="'lantbruk-och-landsbygd.html'"/>
