...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.oikeusministerio.fi/fi/index/julkaisut/esitteet/perustuslaki.html'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="perustuslaki.html"/>
        ...
        <parallel_text xml:lang="sme" location="st303htav303ldisuomasgull303303lbmogii.html"/>
