...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.utsjoki.fi/media/Elinkeinotoimi/Hankkeet/Kielikeskus/saamenkielenkaeyttoeSUOMInet.pdf'"/>
    ...
    <xsl:variable name="author1_ln" select="'Länsman'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Saara'"/>
    <xsl:variable name="author2_ln" select="'Tervaniemi'"/>
    ...
    <xsl:variable name="ISBN" select="'978-952-441-251-3'"/>
    ...
    <xsl:variable name="translator_fn" select="'Pentti'"/>
    <xsl:variable name="translator_ln" select="'Pieski'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="saamenkielenkaeyttoesaamenet.pdf"/>
