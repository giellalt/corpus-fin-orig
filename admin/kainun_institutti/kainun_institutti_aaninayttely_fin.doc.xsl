...
<xsl:variable name="parallels">
	<parallel_text location="kainun_institutti_aaninayttely_fkv.doc" xml:lang="fkv"/>
	<parallel_text location="kainun_institutti_aaninayttely_nob.doc" xml:lang="nob"/>
	<parallel_text location="kainun_institutti_aaninayttely_sme.doc" xml:lang="sme"/>
</xsl:variable>
