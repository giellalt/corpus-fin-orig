...
<xsl:variable name="para_fkv" select="'kainun_institutti_aaninayttely_fkv.doc'"/>
<xsl:variable name="para_ger" select="''"/>
<xsl:variable name="para_isl" select="''"/>
<xsl:variable name="para_kal" select="''"/>
<xsl:variable name="para_nno" select="''"/>
<xsl:variable name="para_nob" select="'kainun_institutti_aaninayttely_nob.doc'"/>
<xsl:variable name="para_sma" select="''"/>
<xsl:variable name="para_sme" select="'kainun_institutti_aaninayttely_sme.doc'"/>
