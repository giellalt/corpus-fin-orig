...
<xsl:variable name="parallels">
	<parallel_text location="kainun_institutti_kesanayttely_2011_a._paulsen_kuvatekstit_kvaani.doc" xml:lang="fkv"/>
	<parallel_text location="institutin_kesanayttely_a._paulsen_kuvalista_norja.doc" xml:lang="nob"/>
</xsl:variable>
