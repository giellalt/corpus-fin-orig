...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Tämä on automaattinen vastaus.'"/>
...
<parallel_text location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf" xml:lang="sms"/>
<parallel_text location="ulkona-tilan_viesteja_-_mallilausekkeet_2011_su-da-an-nu-en-logov3.pdf" xml:lang="eng"/>
    ...
    <xsl:variable name="top_margin" select="'15'"/>
    <xsl:variable name="bottom_margin" select="'73'"/>
