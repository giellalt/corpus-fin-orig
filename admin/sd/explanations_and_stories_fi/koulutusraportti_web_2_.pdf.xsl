...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1211&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saamelaisopetus kotiseutualueen ulkopuolella'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Ulla'"/>
    <xsl:variable name="author1_ln" select="'Aikio-Puoskari'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="skuvlenraportaweb.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-7,15,46'"/>
    ...
    <xsl:variable name="bottom_margin" select="'8=17,10=38,12=60,13=18,14=18,16=18,17=17,18=20,20=51,22=15,23=19,24=20,25=18,27=59,29=15,31=15,32=15,34=18,36=18,41=14,42=72,43=86,44=86,45=89'"/>
    ...
    <!--
        ...
        must be defined.
    -->
    <xsl:variable name="inner_right_margin" select="'11=0,21=0'"/>
    <xsl:variable name="inner_left_margin" select="'11=0,21=0'"/>
    <xsl:variable name="inner_top_margin" select="'11=13,21=13'"/>
    <xsl:variable name="inner_bottom_margin" select="'11=62,21=60'"/>
