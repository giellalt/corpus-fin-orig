...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=2592&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saamelaisten rajayheistyöeseminaari Inarissa 25.2.2015'"/>
    ...
    <parallel_text location="radjeoktasasbargoseminara_loahpalas_pr.pdf" xml:lang="sme"/>
</xsl:variable>
