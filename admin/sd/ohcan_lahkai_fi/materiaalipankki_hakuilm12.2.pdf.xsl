...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Hankkeen käytännön toteuttamista varten saamelaiskäräjät hakee suunnittelijaa'"/>
...
<parallel_text location="materiaalipankki_hakuilm12.2.pdf" xml:lang="sms"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'2=52'"/>
