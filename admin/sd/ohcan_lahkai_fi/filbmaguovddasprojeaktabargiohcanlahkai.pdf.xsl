...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamelaiskäräjät hakee määräaikaista projektityöntekijää elokuvakeskukselle'"/>
...
<parallel_text location="filbmaguovddasprojeaktabargiohcanlahkai.pdf" xml:lang="sms"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="''1=57"/>
