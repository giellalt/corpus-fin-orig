...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamelaiskäräjien saamelaismusiikkikeskus hakee avustajaa määräaikaiseen ja kokopäiväiseen virkasuhteeseen'"/>
...
<parallel_text location="veahkkebargi_veakkteei_iespargee_avustajaa.pdf" xml:lang="sms"/>
</xsl:variable>
