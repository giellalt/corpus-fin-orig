...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Parlamentaarisen neuvoston sihteeristötehtävien ja muita siihen liittyvien kansainvälisten asioiden hoitamista varten Saamelaiskäräjät hakee määräaikaista esittelijää'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sms" location="spr_esittelija_hakuilm_12.2.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'2=48'"/>
