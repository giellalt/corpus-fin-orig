...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamelaiskäräjät ilmoittaa haettavaksi vaalilautakunnan sihteerin määräaikaisen tehtävän aluksi ajalle 11.8.-31.12.2014'"/>
...
<parallel_text location="vaalilautakunnan_sihteeri_4.7.14.pdf" xml:lang="sms"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'2=23'"/>
