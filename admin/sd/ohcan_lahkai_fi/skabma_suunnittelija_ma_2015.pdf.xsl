...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Tätä tehtävää varten saamelaiskäräjät hakee määräaikaista suunnittelijaa'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sms" location="skabma_suunnittelija_ma_2015.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'2=71'"/>
