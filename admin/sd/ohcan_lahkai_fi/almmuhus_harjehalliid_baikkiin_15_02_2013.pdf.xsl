...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Kolme harjoittelupaikkaa haettavana Saamelaiskäräjien sihteeristössä Sajoksessa Inarissa'"/>
...
<parallel_text location="almmuhus_harjehalliid_baikkiin_15_02_2013.pdf" xml:lang="sms"/>
</xsl:variable>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'2-4'"/>
