...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Pohjoismainen saamen kielen kielipalkinto jaetaan syksyllä 2014'"/>
...
<parallel_text location="gollegiella_2014-gulahus_kuulutus.pdf" xml:lang="sms"/>
...
<parallel_text location="gollegiella_2014-gulahus_kuulutus.pdf" xml:lang="sma"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-5,7-9'"/>
    ...
    <xsl:variable name="top_margin" select="'6=11'"/>
    <xsl:variable name="bottom_margin" select="'6=39'"/>
