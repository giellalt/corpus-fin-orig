...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamen kieliteko -palkinnon säännöt'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sms" location="kieliteko_palkinto_saannot_muut_19122011_shall_2_.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'4=65'"/>
    <xsl:variable name="bottom_margin" select="'5=23'"/>
