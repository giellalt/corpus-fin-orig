...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=12&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saamelaismusiikin opetus osaksi Inariin nousevaa saamelaiskulttuurikeskusta'"/>
    ...
    <parallel_text location="diedahus_17012008.pdf" xml:lang="sme"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'2=6'"/>
