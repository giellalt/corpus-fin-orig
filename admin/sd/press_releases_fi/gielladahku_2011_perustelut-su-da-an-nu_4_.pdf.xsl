...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamen kieliteko –palkinnon perustelut'"/>
...
<parallel_text location="gielladahku_2011_perustelut-su-da-an-nu_4_.pdf" xml:lang="sms"/>
</xsl:variable>
