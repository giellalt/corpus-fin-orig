...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1398&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'UUSI KIRJA: Minun Sápmi vuonna 2030'"/>
    ...
    <parallel_text location="tiedote_mu_sapmi_2030.pdf" xml:lang="sme"/>
</xsl:variable>
    ...
    <xsl:variable name="top_margin" select="'1=26'"/>
    <xsl:variable name="bottom_margin" select="'1=49'"/>
