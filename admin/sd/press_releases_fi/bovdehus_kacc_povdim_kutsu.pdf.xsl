...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'Saamelaiskäräjät järjestää saamelaisten kansallispäivän juhlan Inarin'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sms" location="bovdehus_kacc_povdim_kutsu.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=70'"/>
