...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="9_liite_mielddus_anaraspivtastemalmostittem.pdf" xml:lang="smn"/>
<parallel_text location="9b_liite_mielddus_davvisamegillii.pdf" xml:lang="sme"/>
</xsl:variable>
