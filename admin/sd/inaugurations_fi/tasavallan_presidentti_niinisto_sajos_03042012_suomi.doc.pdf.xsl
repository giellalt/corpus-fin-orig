...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_docman&amp;task=doc_download&amp;gid=1862&amp;Itemid=10'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tasavallan presidentin puhe saamelaiskäräjien avajaisissa 3.4.2012'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="index.php_option=com_docman_task=doc_download_gid=1860_itemid=10.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="index.php_option=com_docman_task=doc_download_gid=1861_itemid=10.pdf"/>
