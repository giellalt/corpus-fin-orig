...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.sametinget.no/content/download/2026/19257/version/1/file/Inarin+julkilausuma+YKn+alkuper%C3%A4iskansojen+konferenssista+-+Julistus+suomeksi+darkkistan.pdf'"/>
    ...
    <parallel_text xml:lang="eng" location="final_draft_inari_declaration_120612_rev_2_3_.pdf"/>
	<parallel_text xml:lang="sme" location="evttohuvvon_ana_r-julggaa_tus_a_lgoa_lbmogiid_ma_ilmmikonfera_nssa_birra_10.6.2012.pdf"/></xsl:variable>
