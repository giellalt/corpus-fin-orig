...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_contact&amp;task=vcard&amp;contact_id=26&amp;no_html=1&amp;lang=finnish'"/>
...
<xsl:variable name="para_sms" select="'index2.php_option=com_contact_task=vcard_contact_id=26_no_html=1_lang=nuortta'"/>
