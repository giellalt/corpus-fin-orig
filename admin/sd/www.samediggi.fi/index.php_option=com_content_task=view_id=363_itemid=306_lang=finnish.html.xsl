...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=363&amp;Itemid=306&amp;lang=finnish'"/>
...
<xsl:variable name="para_sms" select="'index.php_option=com_content_task=view_id=363_itemid=306_lang=nuortta.html'"/>
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=363_itemid=306_lang=anaras.html'"/>
