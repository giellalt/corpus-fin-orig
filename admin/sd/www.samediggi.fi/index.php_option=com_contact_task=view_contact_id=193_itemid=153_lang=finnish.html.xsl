...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_contact&amp;task=view&amp;contact_id=193&amp;Itemid=153&amp;lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_contact_task=view_contact_id=193_itemid=153_lang=davvi.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="'index.php_option=com_contact_task=view_contact_id=193_itemid=153_lang=nuortta.html'"/>
<xsl:variable name="para_smn" select="'index.php_option=com_contact_task=view_contact_id=193_itemid=153_lang=anaras.html'"/>
