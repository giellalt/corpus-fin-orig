...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=816&amp;Itemid=195&amp;lang=finnish'"/>
    ...
    <parallel_text location="index.php_option=com_content_task=view_id=816_itemid=195_lang=davvi.html" xml:lang="sme"/>
</xsl:variable>
