...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=registration&amp;task=register&amp;lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=registration_task=register_lang=davvi.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="'index.php_option=registration_task=register_lang=nuortta.html'"/>
<xsl:variable name="para_smn" select="'index.php_option=registration_task=register_lang=anaras.html'"/>
