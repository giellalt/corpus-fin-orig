...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_content&amp;task=view&amp;id=51&amp;Itemid=195&amp;lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_content_task=view_id=51_itemid=195_lang=davvi.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="'index.php_option=com_content_task=view_id=51_itemid=195_lang=nuortta.html'"/>
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=51_itemid=195_lang=anaras.html'"/>
