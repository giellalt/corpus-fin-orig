...
<xsl:variable name="parallels">
	<parallel_text location="index2.php_option=com_content_task=view_id=259_lang=davvi.html" xml:lang="sme"/>
	<parallel_text location="index2.php_option=com_content_task=view_id=259_lang=anaras.html" xml:lang="smn"/>
</xsl:variable>
