...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?lang=nuortta&amp;lang=finnish'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="index.php_lang=nuortta_lang=anaras.html" xml:lang="smn"/>
</xsl:variable>
