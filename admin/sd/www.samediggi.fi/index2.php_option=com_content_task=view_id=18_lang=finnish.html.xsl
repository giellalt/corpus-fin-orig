...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index2.php?option=com_content&amp;task=view&amp;id=18&amp;lang=finnish.html'"/>
...
<xsl:variable name="parallels">
	...
	<parallel_text location="index2.php_option=com_content_task=view_id=18_lang=davvi.html" xml:lang="sme"/>
	<parallel_text location="" xml:lang="sms"/>
	<parallel_text location="index2.php_option=com_content_task=view_id=18_lang=anaras.html" xml:lang="smn"/>
</xsl:variable>
