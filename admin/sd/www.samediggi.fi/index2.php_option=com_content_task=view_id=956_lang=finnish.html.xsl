...
<xsl:variable name="parallels">
	<parallel_text location="index2.php_option=com_content_task=view_id=956_lang=english.html" xml:lang="eng"/>
	<parallel_text location="index2.php_option=com_content_task=view_id=956_lang=davvi.html" xml:lang="sme"/>
</xsl:variable>
