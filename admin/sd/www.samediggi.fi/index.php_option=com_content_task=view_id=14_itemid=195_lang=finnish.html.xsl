...
<xsl:variable name="para_eng" select="'index.php_option=com_content_task=view_id=14_itemid=195_lang=english'"/>
...
<xsl:variable name="para_smn" select="'index.php_option=com_content_task=view_id=14_itemid=195_lang=anaras.html'"/>
