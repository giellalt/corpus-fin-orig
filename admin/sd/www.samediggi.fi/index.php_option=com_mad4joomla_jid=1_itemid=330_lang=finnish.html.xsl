...
<xsl:variable name="filename" select="'http://www.samediggi.fi/index.php?option=com_mad4joomla&amp;jid=1&amp;Itemid=330&amp;lang=finnish'"/>
...
<xsl:variable name="para_sme" select="'index.php_option=com_mad4joomla_jid=1_itemid=330_lang=davvi.html'"/>
<xsl:variable name="para_smj" select="''"/>
<xsl:variable name="para_swe" select="''"/>
<xsl:variable name="para_kpv" select="''"/>
<xsl:variable name="para_rus" select="''"/>
<xsl:variable name="para_sms" select="'index.php_option=com_mad4joomla_jid=1_itemid=330_lang=nuortta.html'"/>
<xsl:variable name="para_smn" select="'index.php_option=com_mad4joomla_jid=1_itemid=330_lang=anaras.html'"/>
