...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://julkaisut.metsa.fi/assets/pdf/lp/Csarja/c81.pdf'"/>
    ...
    <xsl:variable name="ISBN" select="'978-952-446-802-2'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="c108.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 11-14, 17, 23, 25, 27, 46, 51, 57, 67, 83, 98, 114-119, 165-182'"/>
    ...
    <xsl:variable name="left_margin" select="'5=2'"/>
    <xsl:variable name="top_margin" select="''"/>
    <xsl:variable name="bottom_margin" select="'164=27'"/>
