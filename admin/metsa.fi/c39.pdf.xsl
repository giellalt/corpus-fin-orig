...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://julkaisut.metsa.fi/assets/pdf/lp/Csarja/c39.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="c40.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-3, 9-11, 20, 23, 28, 31, 44-45, 62, 67, 70, 111-112, 129, 135-137'"/>
    ...
    <xsl:variable name="bottom_margin" select="'38=48'"/>
