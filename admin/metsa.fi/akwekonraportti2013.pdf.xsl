...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://julkaisut.metsa.fi/assets/pdf/lp/Muut/AkweKonraportti2013.pdf'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="akwekonraportti2013.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="akwekonraportti2013.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 6-7, 17, 23, 35, 72-73'"/>
    ...
    <xsl:variable name="bottom_margin" select="'14=70, 16=15, 18=15, 20=25, 22=20, 24=9, 28=25'"/>
