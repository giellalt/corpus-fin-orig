...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/saamelaismuseo-siida-sai-takaisin-inarin-kunnan-toiminta-avustuksen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="smi-museum-siida-was-after-all-granted-a-subsidy-for-its-activities-by-the-municipality-of-inari.html"/>
        ...
        <parallel_text xml:lang="sme" location="smemusea-siida-oaui-ruovttoluotta-anra-gieldda-doaibmadoarjaga.html"/>
