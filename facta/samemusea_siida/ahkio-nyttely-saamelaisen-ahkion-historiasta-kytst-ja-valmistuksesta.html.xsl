...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/ahkio-nyttely-saamelaisen-ahkion-historiasta-kytst-ja-valmistuksesta'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-smi-sled-an-exhibition-on-the-history-use-and-making-of-the-smi-sled.html"/>
        ...
        <parallel_text xml:lang="sme" location="geres-jhus-smi-gerresa-historjjs-geavaheamis-ja-duddjomis.html"/>
