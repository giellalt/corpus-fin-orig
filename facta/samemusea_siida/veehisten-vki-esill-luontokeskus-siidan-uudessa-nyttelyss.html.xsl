...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/veehisten-vki-esill-luontokeskus-siidan-uudessa-nyttelyss'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="a-folk-shaped-by-water-at-display-at-nature-centre-siida2019s-new-exhibition.html"/>
        ...
        <parallel_text xml:lang="sme" location="ziid-veahka-ovdan-luondduguovdd-siidda-oa-jhusas.html"/>
