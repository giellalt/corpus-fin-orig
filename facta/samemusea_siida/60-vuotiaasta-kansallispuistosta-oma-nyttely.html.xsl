...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/60-vuotiaasta-kansallispuistosta-oma-nyttely'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="exhibition-celebrates-the-60th-anniversary-of-lemmenjoki-national-park.html"/>
        ...
        <parallel_text xml:lang="sme" location="60-jahksa-leammi-lbmotmeahcis-ieas-jhus.html"/>
