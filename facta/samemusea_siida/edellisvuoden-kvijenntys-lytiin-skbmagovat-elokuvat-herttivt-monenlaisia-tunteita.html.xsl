...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/edellisvuoden-kvijenntys-lytiin-skbmagovat-elokuvat-herttivt-monenlaisia-tunteita'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="spectator-numbers-higher-than-last-year-2013-films-shown-at-skbmagovat-evoked-a-range-of-emotions.html"/>
        ...
        <parallel_text xml:lang="sme" location="dn-jagi-skbmagovat-aske-mannan-jagi-gehiidlogu.-festivla-filmmat-bohciidahtte-mggalgan-dovdduid.html"/>
