...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/saamelaismuseo-sai-merkittvn-kirjalahjoituksen'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-smi-museum-received-a-notable-book-donation.html"/>
        ...
        <parallel_text xml:lang="sme" location="smemusea-oaui-mearkkaahtti-girjeskekema.html"/>
