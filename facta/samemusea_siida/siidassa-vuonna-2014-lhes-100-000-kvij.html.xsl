...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/siidassa-vuonna-2014-lhes-100-000-kvij'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="siida-had-almost-100-000-visitors-in-2014.html"/>
        ...
        <parallel_text xml:lang="sme" location="siiddas-fitne-2014-s-lagabui-100-000-olbmo.html"/>
