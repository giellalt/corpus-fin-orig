...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samimuseum.fi/anaras/kieli/kertomaperinne.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Matti'"/>
    <xsl:variable name="author1_ln" select="'Morottaja'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="kertomaperinne.html"/>
        ...
        <parallel_text xml:lang="smn" location="kertomaperinne.html"/>
