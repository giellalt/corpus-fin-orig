...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.siida.fi/sisalto/tiedotteet/maorit-valokeilassa-vuoden-2017-skbmagovat-festivaalilla'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="the-2017-skbmagovat-film-festival-spotlights-the-maori.html"/>
        ...
        <parallel_text xml:lang="sme" location="maorit-lvkejit-lvdi-jagi-2017-skbmagovat-festivlas.html"/>
