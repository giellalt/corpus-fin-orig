...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="author1_fn" select="'Veli-Pekka'"/>
    <xsl:variable name="author1_ln" select="'Lehtola'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Sigga-Marja'"/>
    <xsl:variable name="author2_ln" select="'Magga'"/>
    ...
    <language xml:lang="eng"/><language xml:lang="sme"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="beaivvas_biktasat.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-4, 6, 9, 13, 15, 16, 19, 20, 26, 29, 33-35, 37-43, 45-47, 49-53, 55-60'"/>
    ...
    <!--
        ...
        1;3;8=20, 4;5;7=10
    -->
    <xsl:variable name="right_margin" select="'all=35, 8;10;12;14;18;22;24;28;30=40, 3;4;32;36;44;48;54=7'"/>
    <xsl:variable name="left_margin" select="'all=30, 5=50'"/>
    <xsl:variable name="top_margin" select="'3;36=60, 32;40;44;48;54=50'"/>
    <xsl:variable name="bottom_margin" select="'23=50, 25=60, 31=25'"/>
