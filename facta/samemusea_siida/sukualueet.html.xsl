...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.samimuseum.fi/anaras/ymparisto/sukualueet.html'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Irja'"/>
    <xsl:variable name="author1_ln" select="'Jefremoff'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="sukualueet.html"/>
        ...
        <parallel_text xml:lang="smn" location="sukualueet.html"/>
