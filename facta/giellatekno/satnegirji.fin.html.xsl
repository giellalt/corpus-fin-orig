...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://oahpa.no/sme/usevisl/satnegirji.fin.html'"/>
    ...
    <parallel_text location="satnegirji.html" xml:lang="sme"/>
<parallel_text location="satnegirji.eng.html" xml:lang="eng"/>
<parallel_text location="satnegirji.swe.html" xml:lang="swe"/>
</xsl:variable>
