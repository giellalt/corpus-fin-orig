...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <parallel_text location="oahpaheaddji.sme.html" xml:lang="sme"/>
<parallel_text location="oahpaheaddji.eng.html" xml:lang="eng"/>
<parallel_text location="oahpaheaddji.nob.html" xml:lang="nob"/>
</xsl:variable>
