...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://oahpa.no/sme/index.fin.html'"/>
    ...
    <parallel_text location="index.html" xml:lang="sme"/>
<parallel_text location="index.eng.html" xml:lang="eng"/>
<parallel_text location="index.nob.html" xml:lang="nob"/>
<parallel_text location="index.swe.html" xml:lang="swe"/>
</xsl:variable>
