...
<xsl:variable name="filename" select="'kokouskuulumisia-kansallisesta.html'"/>
<xsl:variable name="title" select="'Kokouskuulumisia kansallisesta metsäohjelmasta ja saamelaisesta parlamentaarisesta neuvostosta'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/02/kokouskuulumisia-kansallisesta.html'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="oakknsgat-lbmotla-vuovdeprogrmmas-ja.html" xml:lang="sme"/>
</xsl:variable>
