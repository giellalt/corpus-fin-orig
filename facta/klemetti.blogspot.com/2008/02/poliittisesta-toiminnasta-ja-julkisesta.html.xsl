...
<xsl:variable name="filename" select="'poliittisesta-toiminnasta-ja-julkisesta.html'"/>
<xsl:variable name="title" select="'Poliittisesta toiminnasta ja julkisesta keskustelusta'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/02/poliittisesta-toiminnasta-ja-julkisesta.html'"/>
...
<xsl:variable name="wordcount" select="'1173'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="politihkala-doaimmas-ja-almmola.html" xml:lang="sme"/>
</xsl:variable>
