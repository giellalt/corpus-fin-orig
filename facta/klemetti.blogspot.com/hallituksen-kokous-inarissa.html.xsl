...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'hallituksen-kokous-inarissa.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Hallituksen kokous Inarissa'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/02/hallituksen-kokous-inarissa.html'"/>
    ...
    <xsl:variable name="wordcount" select="'813'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="stivrra-oakkn-anris.html"/>
