...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'kulunut-viikko-ja-sen-tapahtumat.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kulunut viikko ja sen tapahtumat'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/03/kulunut-viikko-ja-sen-tapahtumat.html'"/>
    ...
    <xsl:variable name="wordcount" select="'846'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="vssn-vahku-fearnat.html"/>
