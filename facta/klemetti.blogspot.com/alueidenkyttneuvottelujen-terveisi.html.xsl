...
<xsl:variable name="filename" select="'alueidenkyttneuvottelujen-terveisi.html'"/>
<xsl:variable name="title" select="'Alueidenkäyttöneuvottelujen terveisiä'"/>
...
<xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/02/alueidenkyttneuvottelujen-terveisi.html'"/>
...
<xsl:variable name="wordcount" select="'893'"/>
...
<xsl:variable name="parallels">
	<parallel_text location="guovlluidgeavahusrdallamiid.html" xml:lang="sme"/>
</xsl:variable>
