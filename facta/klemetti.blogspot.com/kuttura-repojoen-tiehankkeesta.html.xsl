...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'kuttura-repojoen-tiehankkeesta.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Kuttura-Repojoen tiehankkeesta'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/03/kuttura-repojoen-tiehankkeesta.html'"/>
    ...
    <xsl:variable name="wordcount" select="'1011'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="luoddaplnas-guhtura-ja-riebanjoga.html"/>
