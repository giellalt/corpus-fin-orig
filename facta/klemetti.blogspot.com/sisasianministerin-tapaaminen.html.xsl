...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'sisasianministerin-tapaaminen.html'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Sisäasianministerin tapaaminen'"/>
    <!--
    ...
    <xsl:variable name="place" select="'http://klemetti.blogspot.com/2008/03/sisasianministerin-tapaaminen.html'"/>
    ...
    <xsl:variable name="wordcount" select="'805'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="sisiidministeriija-deaivvadeapmi.html"/>
