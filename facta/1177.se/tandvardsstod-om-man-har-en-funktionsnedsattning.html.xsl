...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Finska/Regler-och-rattigheter/Tandvardsstod-om-man-har-en-funktionsnedsattning'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="tandvardsstod-om-man-har-en-funktionsnedsattning.html"/>
        <parallel_text xml:lang="fin" location=""/>
        <parallel_text xml:lang="fit" location="tandvardsstod-om-man-har-en-funktionsnedsattning.html"/>
        ...
        <parallel_text xml:lang="sme" location="tandvardsstod-om-man-har-en-funktionsnedsattning.html"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="tandvardsstod-om-man-har-en-funktionsnedsattning.html"/>
    </xsl:variable>
