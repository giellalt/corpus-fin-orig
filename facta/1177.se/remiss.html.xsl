...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.1177.se/Nationella-minoritetssprak/Nationella-minoritetssprak/Finska/Regler-och-rattigheter/Remiss'"/>
    ...
    <parallel_text xml:lang="eng" location="remiss.html"/>
	<parallel_text xml:lang="rmn" location="remiss.html"/>
	<parallel_text xml:lang="rmy-rlo" location="remiss.html"/>
	<parallel_text xml:lang="sme" location="remiss.html"/>
	<parallel_text xml:lang="swe" location="remiss.html"/></xsl:variable>
