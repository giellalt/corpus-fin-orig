...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.folkhalsomyndigheten.se/contentassets/eacde63d75f24cb091cfe7eaaabec4f4/faktablad-covid-19-finska.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Tietoja uudesta koronaviruksesta ja covid-19-taudista'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="covid_19_faktablad_engelska.pdf"/>
        <parallel_text xml:lang="fin" location=""/>
        <parallel_text xml:lang="fit" location="covid_19_faktablad_meankieli.pdf"/>
        ...
        <parallel_text xml:lang="sma" location="covid_19_faktablad_sydsamiska.pdf"/>
        <parallel_text xml:lang="sme" location="covid_19_faktablad_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="allmant_om_covid19.pdf"/>
    </xsl:variable>
