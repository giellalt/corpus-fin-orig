...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.folkhalsomyndigheten.se/contentassets/cdba13482a954d05b78778f8df109687/faktablad-covid-19-70-ar-finska.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Jos olet vähintään 70-vuotias, rajoita lähikontaktejasi'"/>
    <!--
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sma" location="faktablad_covid_19-70-ar_sydsamiska.pdf"/>
        <parallel_text xml:lang="sme" location="faktablad_covid_19-70-ar_nordsamiska.pdf"/>
        <parallel_text xml:lang="smj" location=""/>
        <parallel_text xml:lang="smn" location=""/>
        <parallel_text xml:lang="sms" location=""/>
        <parallel_text xml:lang="swe" location="faktablad_covid_19-70-ar_svenska.pdf"/>
    </xsl:variable>
