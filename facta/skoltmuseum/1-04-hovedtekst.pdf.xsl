...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <language xml:lang="nob"/><language xml:lang="eng"/><language xml:lang="rus"/><language xml:lang="fin"/><language xml:lang="sms"/></xsl:variable>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sms" location="1-04-hovedtekst.pdf"/>
    ...
    <xsl:variable name="top_margin" select="'1=55, 2=60'"/>
    <xsl:variable name="bottom_margin" select="'1=30, 2=30'"/>
