...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://saradutkan.fi/2016/09/22/geas-leat-navccat-gaibidit-kenella-on-voimia-vaatia/'"/>
    ...
    -->
    <xsl:variable name="author1_fn" select="'Tuuli'"/>
    <xsl:variable name="author1_ln" select="'Miettunen'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="index_6.html"/>
