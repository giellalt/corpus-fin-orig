...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    <xsl:variable name="title" select="'”Dat ii leat dušše dat giella” – ”Se ei ole vain se kieli”. 
Tapaustutkimus saamenkielisestä kielipesästä saamelaisessa varhaiskasvatuksessa'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Rauni'"/>
    <xsl:variable name="author1_ln" select="'Äärelä'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="rauni_aarele_phd.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="rauni_aarele_phd.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-7, 11-236'"/>
