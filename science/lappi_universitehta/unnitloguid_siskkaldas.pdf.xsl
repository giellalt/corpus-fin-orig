...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://lauda.ulapland.fi/bitstream/handle/10024/63084/Olsén.Laura%3B%20%20Heinämäki.Leena%3B%20Harkoma.Assi.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Unnitloguid siskkáldas unnitloguid olmmošvuoigatvuođat ja máŋggadáfot vealaheapmi: sápmelaš lámisolbmot ja seksuála- ja sohkabealleunnitlogut'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Laura'"/>
    <xsl:variable name="author1_ln" select="'Olsén'"/>
    <!-- m, f or unknown -->
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author2_fn" select="'Leena'"/>
    <xsl:variable name="author2_ln" select="'Heinŋamŋaki'"/>
    ...
    <!--
        ...
        date or year of birth, nationality.
    -->
    <xsl:variable name="author3_fn" select="'Assi'"/>
    <xsl:variable name="author3_ln" select="'Harkoma'"/>
    ...
    <xsl:variable name="translator_fn" select="'Arla'"/>
    <xsl:variable name="translator_ln" select="'Magga'"/>
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="sme" location="unnitloguid_siskkaldas.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-17, 235-518'"/>
