...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'http://lauda.ulapland.fi/bitstream/handle/10024/62576/Rahko-Ravantti_ActaE_200_pdfA.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Saamelaisopetur Suomessa. Tutkomus saamelaisopettajien opetustyöstä suomalaiskouluissa.'"/>
    <!--
        Information of the first author: first name, last name,
        date or year of birth, nationality.
    -->
    <xsl:variable name="author1_fn" select="'Rauna'"/>
    <xsl:variable name="author1_ln" select="'Rahko-Ravantti'"/>
    <!-- m, f or unknown -->
    ...
    <xsl:variable name="parallels">
        ...
        <parallel_text xml:lang="eng" location="rahko-ravantti_phd.pdf"/>
        ...
        <parallel_text xml:lang="sme" location="rahko-ravantti_phd.pdf"/>
    ...
    <!--
        ...
        1, 6-10, 15, 20, 25-30
    -->
    <xsl:variable name="skip_pages" select="'1-11, 14-145'"/>
    ...
    <xsl:variable name="top_margin" select="'12=12'"/>
    <xsl:variable name="bottom_margin" select="'all=12'"/>
